...
import { PortfolioRiskIndicatorsPanel } from "./portfolio-risk-indicators-panel";
...
export function PortfolioExposurePanel({
  ...
  return (
    <>
      ...
      <PortfolioRiskIndicatorsPanel
        portfolioId={exposure.portfolio.portfolio_id}
        refreshKey={exposure.assessed_at}
      />
    </>
  );
}
