...
export const primaryNavigation: NavigationItem[] = [
  {
    ...
    href: "/",
    description: "Global market signals and developments.",
  },
  {
    label: "News",
    href: "/news",
    description: "News and information affecting markets.",
  },
  {
    label: "Events",
    href: "/events",
    description: "Important global events and market catalysts.",
  },
  {
    label: "Companies",
    href: "/companies",
